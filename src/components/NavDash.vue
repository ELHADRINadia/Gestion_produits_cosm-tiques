           ...
           <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
               <li class="nav-item dropdown">
                   ...
                   <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                       ...
                       <li><a class="dropdown-item" href="/Profil">Users</a></li>
                       <li><a class="dropdown-item" href="/message">Messages</a></li>
                       <li><a class="dropdown-item" href="/commande">Commandes</a></li>
